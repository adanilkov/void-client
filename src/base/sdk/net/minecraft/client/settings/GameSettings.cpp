...
CGameSettings::CGameSettings()
{
	...
	this->FieldIDs["keyBindUseItem"] = Java::Env->GetFieldID(this->Class, "keyBindUseItem", "Lnet/minecraft/client/settings/KeyBinding;");
}
...
jobject CGameSettings::GetUseItem()
{
	return Java::Env->GetObjectField(GetInstance(), this->FieldIDs["keyBindUseItem"]);
}
