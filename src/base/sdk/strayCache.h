...
struct StrayCache {
	...
	inline static jclass keyBinding_class;
	inline static jmethodID keyBinding_setKeyBindState;
	...
	static void Initialize() {
		...
		itemStack_getItem = Java::Env->GetMethodID(itemStack_class, "getItem", "(I)Lnet/minecraft/item/ItemStack;");
		itemStack_getDisplayName = Java::Env->GetMethodID(itemStack_class, "getDisplayName", "()Ljava/lang/String;");

		Java::AssignClass("net.minecraft.client.settings.KeyBinding", keyBinding_class);
		keyBinding_setKeyBindState = Java::Env->GetMethodID(keyBinding_class, "bridge$setKeyBindState", "(Z)V");
