...
void Menu::DoSliderStuff(int id, const char* text, float* b, float min, float max) {
...
void Menu::DoToggleButtonStuff(int id, const char* text, bool* b) {
	ImVec2 textSize = Menu::Font->CalcTextSizeA(Menu::Font->FontSize, FLT_MAX, 0.0f, text);
